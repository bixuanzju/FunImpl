...
\newcommand{\letb}[3]{\mathbf{let}\,#1 = #2\,\inb\,#3}
...
\begin{figure}[ht]
  ...
  \begin{syntax}
    ...
    decl &::= & \hlmath{\data\,T\,\overline{\mid K\,\overline{A}}} & \ptext{Datatype} \\
    ...
    & \mid & \hlmath{\letb{x}{A}{A}} & \ptext{Let binding} \\
...
\begin{figure}[ht]
  ...
  \begin{tabular}{lcl}
    ...
    (Let) & \ruleII{\ctx{e_{1}:A}}{\ctxw{x:A}{e_{2}:B}}{\letb{x}{e_{1}}{e_{2}}:B} \\
...
\begin{figure}[ht]
  \centering \small
  \begin{tabular}{lcl}
    \framebox{$\Gamma \vdash e : A \rightsquigarrow \hat{e}$} \\
    (Ax) & \ruleI{}{\ctxz{\star:\square \rightsquigarrow \star}} \\

    (Var) & \ruleI{x:A \in \Gamma}{\ctx{x:A \rightsquigarrow x}} \\

    (App) & \ruleII{\ctx{f:(\pai{x}{A}{B}) \rightsquigarrow \hat{f}}}{\ctx{a:A \rightsquigarrow \hat{a}}}{\ctx{fa:B[x:=a] \rightsquigarrow \hat{f}\hat{a}}} \\

    (Lam) & \ruleII{\ctxw{x:A}{b:B \rightsquigarrow \hat{b}}}{\ctx{(\pai{x}{A}{B}):t}}
            {\ctx{(\lam{x}{A}{b}}):(\pai{x}{A}{B}) \rightsquigarrow \lam{x}{A}{\hat{b}}}
          & $t \in \{\star, \square\}$ \\

    (Pi) & \ruleII{\ctx{A:s}}{\ctxw{x:A}{B:t}}{\ctx{(\pai{x}{A}{B}):t \rightsquigarrow \pai{x}{A}{B}}}
          & $(s,t) \in \mathcal{R}$ \\

    (Mu) & \ruleI{\ctxw{x:s}{A:s}}{\ctx{(\miu{x}{A}):s \rightsquigarrow \miu{x}{A}}} \\

    (Fold) & \ruleII{\ctx{a:(A[x:=\miu{x}{A}]) \rightsquigarrow \hat{a}}}{\ctx{\miu{x}{A}:s}}%
             {\ctx{(\fold{\miu{x}{A}}{a}):\miu{x}{A} \rightsquigarrow \fold{\miu{x}{A}}{\hat{a}}}} \\

    (Unfold) & \ruleII{\ctx{a:\miu{x}{A} \rightsquigarrow \hat{a}}}{\ctx{A[x:=\miu{x}{A}]:s}}%
               {\ctx{(\unfold{a}):A[x:=\miu{x}{A}] \rightsquigarrow \unfold{\hat{a}}}} \\
    ...
    (Case) & \ruleII{\ctx{e:T \rightsquigarrow \hat{e}}}{\overline{\Gamma\vdash_{p} p \Rightarrow e:T \rightarrow B \rightsquigarrow E_{1}}}{\Gamma\vdash\case\,e\,\of\,\overline{p \Rightarrow e}:B \rightsquigarrow (\unfold{\hat{e}})\,B\,\overline{E_{1}}}\\
