...
\item We can encode the type of lists of natural numbers as follows:
  ...
  \begin{align*}
    \nil &: \List\\
    \nil &= \fold{\List}{(\lambda (a : \star) (z : a) (f : \Nat
           \rightarrow \List \rightarrow a).\ z)}\\
    \cons &: \Nat \rightarrow \List \rightarrow \List\\
    \cons &= \lambda(x : \Nat)(xs : \List).\ \fold{\List}{(\lambda(a :
            \star)(z : a)(f : \Nat \rightarrow \List \rightarrow a).\ f\,x\,xs)}
  \end{align*}
  ...
  \begin{align*}
    ...
    \length &= \mathsf{fix}\,(\List \rightarrow \Nat)\,(\lambda(l : \List
            ...
            &\qquad (\unfold{\List}{xs})\,\Nat\,\zero\,(\lambda(y :
              \Nat)(ys : \List).\,\suc\,(l\,ys)))
  \end{align*}
\item We can encode the type of vectors of a certain length as follows:
\end{itemize}
