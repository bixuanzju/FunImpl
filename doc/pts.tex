...
\begin{center}
  ...
  \{$K_{j}\ \vec{\mathbf{u}}\ \vec{\mathbf{\alpha}} \Rightarrow
  res_{j}$\}
  $\rightarrow_{c} (\lambda \vec{\mathbf{u}}:\vec{\mathbf{\tau}},\
  \vec{\mathbf{\alpha}}:\vec{\mathbf{t_{j}}}.\ res_{j})\ \vec{\mathbf{x}}$
\end{center}
...
\begin{table}[H]
  ...
  \begin{tabular}{lc}
    (Case) &
             ...
             \UnaryInfC{$\Gamma \vdash_{c} K_{j}\
             \vec{\mathbf{u^{\prime}}} : \Pi \vec{\mathbf{\alpha}} :
             \vec{\mathbf{t_{j}}}.\ (T\ \vec{\mathbf{u^{\prime}}})$}
             \UnaryInfC{$\Gamma,
             \vec{\mathbf{\alpha}}:\vec{\mathbf{t_{j}}} \vdash_{c}
             res_{j}[\vec{\mathbf{u}} := \vec{\mathbf{u^{\prime}}}] : t$}
             \UnaryInfC{$\Gamma \vdash_{c} t : s$}
             \alwaysSingleLine
             \UnaryInfC{$\Gamma \vdash_{c}$ case $e$ of \{$K_{j}\
             \vec{\mathbf{u}}\ \vec{\mathbf{\alpha}} \Rightarrow
             res_{j}$\} : $t$}
             \DisplayProof \\
...
$\vec{\mathbf{\alpha}}$ and binds them to $\vec{\mathbf{t_{j}}}$,
