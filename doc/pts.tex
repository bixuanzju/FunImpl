...
\item Here we present a type system called \emph{the calculus of
    construction ($\lambda C$)}, where
...
$K_{j} (1 \leqslant j \leqslant n)$ data constructor of types
$\alpha_{j1}, \dots, \alpha_{jk_{j}}$. Each $u_{i}$ is a variable of
