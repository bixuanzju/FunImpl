...
System~$F_{\omega}$~\cite{systemfw}, needs to be used. Ofcourse the
...
languages, such as System FC~\cite{fc}, that provide support for all
modern features of Haskell. Although \emph{extensions} of System
FC~\cite{Yorgey:2012,Eisenberg:2014} satisfy the current needs of
modern Haskell, it is very likely to be extended again in the
future~\cite{fc:kind}. Moreover System FC has grown to be a relatively
...
researchers~\cite{zombie:popl14,zombie:thesis}\bruno{more references?}
