...
\ottGs}
    ...
    \begin{array}{lllll}
    \text{Syntactic Sugar} &&&& \\
    \quad\text{Let binding} & [[let x : A = E2 in E1]] & \triangleq & [[(\x:A.E1)E2]] & \\
    \quad\text{Function type} & [[A1->A2]] & \triangleq & [[Pi x:A1.A2]] & x \not \in \FV([[A2]]) \\
    \quad\text{Dependent function type} & [[(x:A1)->A2]] & \triangleq & [[Pi x:A1.A2]] & x \in \FV([[A2]])\\
    \quad\text{Record} & [[data R </ul:kl // l/> = K { </Ni:Ai // i/> }]] & \triangleq &
                    [[data R </ul:kl //l/> = K </ Ai //i/>]]; & \\
                  &&& [[let]]~[[N]]_i : [[ (</uj:kj//j/>) ]] [[->]] [[ R </ul//l/> -> A]]_i = & \forall [[N]]_i \\
                  &&& [[\ </uj:kj //j/> ]] . [[ \ y : R </ul//l/> ]] . [[case y of K </xi:Ai//i/> => x]]_i~[[in]] & \\
    \end{array}
    \]
