...
Given $[[Gs |- E : A]]$, if $[[|- Gs ~> G]]$, $[[Gs |- E:A ~> e]]$ and $[[Gs |- A:star ~> t]]$, then $[[G |- e:t]]$.
\end{lem}

\begin{proof}
    By induction on the derivation of $[[Gs |- E : A]]$:
    \begin{description}
        \item[Case $[[E=star]]$:]
    \end{description}
\end{proof}
...
Given $[[Gs |- decl : Gs']]$, if $[[|- Gs ~> G]]$, $[[Gs |- decl:Gs' ~> e]]$ and \fixme{$[[t]]=?$}, then $[[G |- e:t]]$.
\end{lem}
