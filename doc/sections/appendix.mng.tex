...
\ruleref{SC\_Case} and \ruleref{SC\_CaseMatch}.
    \begin{description}
        ...
        \[\begin{array}{l}
            ...
            [[Gs |- case E1' of << p => E >> : A ~> (unfoldn e1') t <<e>>]]. 
        \end{array} \] 
    By \ruleref{S\_CastDown}, we have the result
...
\ruleref{TRpat\_Alt} and \ruleref{TR\_Case}, we have 
        \[
        [[Gs |- case Ki <<u>>
...
A:star~>t]]$.
        \item[Case \ruleref{TR\_App}:] Suppose
            ...
            \[\begin{array}{l}
             [[Gs |- E1 : (Pi x:A2.A1) ~> e1]] \\
              ...
              [[Gs |- E2 : A2 ~> e2]] \\
              [[Gs |- A2 : star ~> t2]].
            \end{array}\] Thus by rule \ruleref{T\_App}, we have $[[G |- e1 e2 : t1 [x |-> e2] ]]$.
        \item[Case \ruleref{TR\_Lam}:] Suppose
            ...
            \end{array}
            \]
            Thus by rule \ruleref{T\_Lam}, we have $[[G |- (\x:t1.e):(Pi x:t1.t2)]]$.
        \item[Case \ruleref{TR\_Pi}:] Suppose 
            ...
            \]
            Thus by rule \ruleref{T\_Pi} $[[G |- (Pi x:t1.t2) : star]]$.
        ...
        \item[Case \ruleref{TR\_CastDown}:] Suppose 
            ...
            Thus, by rule \ruleref{T\_CastDown}, we have $[[G |- castdown e : t2]]$.
        \item[Case \ruleref{TR\_Mu}:] Suppose 
            ...
            Thus by rule \ruleref{T\_Mu}, we have $[[G |- (mu x:t.e) : t]]$.
