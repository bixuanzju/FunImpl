...
\ref{lem:appendix:gen}, $[[t2[x |-> e2] ]]$ is the unique type of $[[e]]$.
		\item[Case $[[e=\x:t1.e1]]$:] By rule \ruleref{T\_Lam} and introduction
...
\ref{lem:appendix:gen}, $[[Pi x:t1.t2 ]]$ is the unique type of $[[e]]$.
		\item[Case $[[e=Pi x:t1.t2]]$:] By rule \ruleref{T\_Pi} and introduction
hypothesis, we have $[[G |- t1:s]]$ and $[[G, x:t1 |- t2:s]]$. Thus, from Lemma
\ref{lem:appendix:gen}, $[[s]]$ is the unique type of $[[e]]$.
		\item[Case $[[e=mu x:t.e1]]$:] By rule \ruleref{T\_Mu} and introduction
...
A:star~>t]]$.
        ...
        \item[Case \ruleref{TR\_Pi}:] Suppose 
            ...
            $
            Thus by rule \ruleref{T\_Pi} we have $[[G |- (Pi x:t1.t2) : star]]$.
