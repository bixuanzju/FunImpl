...
\>[3]{}\mathbf{letrec}\;\Varid{many}\mathbin{:}\star\to \star\to \Conid{Nat}\to \star\mathrel{=}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\lambda \Varid{a}\mathbin{:}\star.\,\lambda \Varid{b}\mathbin{:}\star.\,\lambda \Varid{n}\mathbin{:}\Conid{Nat}.\,{}\<[E]%
\\
\>[5]{}\hsindent{3}{}\<[8]%
\>[8]{}\mathbf{case}\;\Varid{n}\;\mathbf{of}{}\<[E]%
\\
\>[8]{}\hsindent{2}{}\<[10]%
\>[10]{}\Conid{Zero}\Rightarrow \Varid{b}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mid {}\<[7E]%
\>[10]{}\Conid{Suc}\;(\Varid{m}\mathbin{:}\Conid{Nat})\Rightarrow \Varid{a}\to \Varid{many}\;\Varid{a}\;\Varid{b}\;\Varid{m}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\ensuremath{\Varid{many}} takes two types and a natural number, produces another type
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{many}\;\Conid{Nat}\;\Conid{Bool}\;\Conid{Z}{}\<[28]%
\>[28]{}\mbox{\onelinecomment  return ``Bool''}{}\<[E]%
\\
\>[3]{}\Varid{many}\;\Conid{Nat}\;\Conid{Bool}\;(\Conid{S}\;\Conid{Z}){}\<[28]%
\>[28]{}\mbox{\onelinecomment  return ``Nat $\rightarrow$ Bool''}{}\<[E]%
\\
\>[3]{}\Varid{many}\;\Conid{Nat}\;\Conid{Bool}\;(\Conid{S}\;(\Conid{S}\;\Conid{Z})){}\<[28]%
\>[28]{}\mbox{\onelinecomment  return ``Nat $\rightarrow$ Nat $\rightarrow$ Bool''}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
What might this be useful? It could be used to write a very simplified
version of variable-arity \ensuremath{\Varid{zipWith}} that takes a number $n$ as arity,
a type $t$, another type $g$, a function of type \ensuremath{\Varid{many}\;\Varid{t}\;\Varid{g}\;\Varid{n}}, $n$
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{zipWith}\mathbin{:}{}\<[14]%
\>[14]{}(\Varid{n}\mathbin{:}\Conid{Nat})\to (\Varid{t}\mathbin{:}\star)\to (\Varid{g}\mathbin{:}\star)\to (\Varid{many}\;\Varid{t}\;\Varid{g}\;\Varid{n})\to {}\<[E]%
\\
\>[14]{}(\Varid{many}\;(\Conid{List}\;\Varid{t})\;(\Conid{List}\;\Varid{g})\;\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
The problem arises when we try to figure out how many \cast operations
(or beta reductions) are needed for \ensuremath{\Varid{many}} function to compute
something useful (e.g., by analysis, it needs at least 6 \ensuremath{\mathsf{cast}_\downarrow}'s
