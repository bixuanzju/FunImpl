...
not restricted. So we can define the \emph{multi-step reduction} as follows:
...
e']]$. The lemma follows by induction on the number of one-step reductions
of $[[e]] [[->>]] [[e']]$.
...
$n$-step $[[castup]]$ operator by leaving out intermediate types. 
From Lemma \ref{lem:ecore:unique}, 
...
them out in the $[[foldn]]$ operator and obtain the following form:
\[
    [[foldn [t1] e]] : [[t1]].
\]
