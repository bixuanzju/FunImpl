...
\\
\>[3]{}\mathbf{in}\;\Varid{length}\;\Varid{nat}\;\Varid{test}\mbox{\onelinecomment  returns 2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Using \ensuremath{\Conid{Exp}} we can write an evaluator for the lambda calculus. As noted
...
\\
\>[3]{}\mathbf{letrec}\;\Varid{ev}\mathbin{:}\Conid{Eval}\mathrel{=}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Ev}\;{}\<[9]%
...
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Conid{VF}\;(\lambda \Varid{e'}\mathbin{:}\Conid{Value}.\,\Varid{eval'}\;\Varid{ev}\;(\Varid{fun}\;(\Varid{reify'}\;\Varid{ev}\;\Varid{e'}))){}\<[E]%
\\
\>[9]{}\mid \Conid{App}\;(\Varid{a}\mathbin{:}\Conid{Exp})\;(\Varid{b}\mathbin{:}\Conid{Exp})\Rightarrow {}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{case}\;\Varid{eval'}\;\Varid{ev}\;\Varid{a}\;\mathbf{of}{}\<[E]%
\\
\>[13]{}\hsindent{2}{}\<[15]%
\>[15]{}\Conid{VI}\;(\Varid{n}\mathbin{:}\Varid{nat})\Rightarrow \Varid{error}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mid \Conid{VF}\;(\Varid{fun}\mathbin{:}\Conid{Value}\to \Conid{Value})\Rightarrow \Varid{fun}\;(\Varid{eval'}\;\Varid{ev}\;\Varid{b}))\;{}\<[E]%
\\
...
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\Conid{Lam}\;(\lambda \Varid{e'}\mathbin{:}\Conid{Exp}.\,(\Varid{reify'}\;\Varid{ev}\;(\Varid{fun}\;(\Varid{eval'}\;\Varid{ev}\;\Varid{e'}))))){}\<[E]%
\\
\>[3]{}\mathbf{in}\;\mathbf{let}\;\Varid{eval}\mathbin{:}\Conid{Exp}\to \Conid{Value}\mathrel{=}\Varid{eval'}\;\Varid{ev}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ColumnHook
\end{hscode}\resethooks
\bruno{Code needs to be explained! In particular explain the \ensuremath{\Conid{Func}\;\Conid{Maybe}}.}
...
an \ensuremath{\Varid{a}}, but \emph{PairT a}\bruno{code should be formated writh the proper font!
