...
of $x$  ($\ottsym{(}  \lambda  \ottmv{y}  \ottsym{:}  \star  \ottsym{.}  \ottmv{y}  \ottsym{)} \, \kw{Int}$), which is the argument of $f$, is interesting: it is 
...
f\,(\kw{cast}^{\uparrow} \, \ottsym{[}  \ottsym{(}  \lambda  \ottmv{y}  \ottsym{:}  \star  \ottsym{.}  \ottmv{y}  \ottsym{)} \, \kw{Int}  \ottsym{]} \,  3) \]\bruno{how to put a space
...
reduces the type of $ z $ to $  \kw{Int}  $. \bruno{explain why this is a reduction}
