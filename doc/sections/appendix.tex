...
have $ \labeledjudge{wf}  \Sigma   \rightsquigarrow   \Gamma $, then $\ottmv{x}:\tau  \in  \Gamma$ where $ \Sigma  \labeledjudge{s}  T  :  \star   \rightsquigarrow   \tau $.
        ...
        \item[Case \ruleref{TR\_Pi}:] Suppose 
            ...
            \]
            Thus by rule \ruleref{T\_Pi} $\Gamma  \vdash  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}}  \ottsym{)}  \ottsym{:}  \star$.
        \item[Case \ruleref{TR\_CastUp}:] Suppose 
            ...
            \ruleref{T\_CastUp}, we have $\Gamma  \vdash  \mathsf{cast}^{\uparrow} \, \ottsym{[}  \tau_{{\mathrm{1}}}  \ottsym{]} \,  \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{1}}}$.
        \item[Case \ruleref{TR\_CastDown}:] Suppose 
            ...
            Thus, by rule \ruleref{T\_CastDown}, we have $\Gamma  \vdash  \mathsf{cast}_{\downarrow} \, \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{2}}}$.
        ...
        \item[Case \ruleref{TR\_Case}:] Suppose 
            ...
            \ruleref{T\_App}, we obtain $\Gamma  \vdash  \ottsym{(}  \mathsf{cast}_{\downarrow}^n \, \ottnt{e_{{\mathrm{1}}}}  \ottsym{)} \, \tau \, \,\overline{  \ottnt{e_{{\mathrm{2}}}}  }\,  \ottsym{:}  \tau$, which follows
            the result.
    \end{description}
\end{proof}
