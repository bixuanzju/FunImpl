...
\begin{proof}
    By induction on the relation $\ottnt{E_{{\mathrm{1}}}}  \longrightarrow  \ottnt{E_{{\mathrm{2}}}}$. We only treat the non-trivial case \ruleref{SC\_CaseMatch}.
\end{proof}

\begin{lem}[Type-safety of expression translation]
If $ \varnothing  \labeledjudge{s}  \ottnt{E}  :  T   \rightsquigarrow   \ottnt{e} $ and $ \varnothing  \labeledjudge{s}  T  :  \star   \rightsquigarrow   \tau $, then $\varnothing  \vdash  \ottnt{e}  \ottsym{:}  \tau$.
\end{lem}

\begin{proof}
    By induction on the derivation of $ \varnothing  \labeledjudge{s}  \ottnt{E}  :  T $.
    \begin{description}
        \item[Case \ruleref{TR\_Ax}:] Trivial. $\ottnt{e} = \tau = \star$ and $\varnothing  \vdash  \star  \ottsym{:}  \star$ holds by rule \ruleref{T\_Ax}.
        \item[Case \ruleref{TR\_Var}:] Impossible, since the context is empty.
        \item[Case \ruleref{TR\_App}:] Suppose $ \varnothing  \labeledjudge{s}  \ottnt{E_{{\mathrm{1}}}} \, \ottnt{E_{{\mathrm{2}}}}  :  T_{{\mathrm{1}}}  \ottsym{[}  \ottmv{x}  \mapsto  \ottnt{E_{{\mathrm{2}}}}  \ottsym{]} \,   \rightsquigarrow   \ottnt{e_{{\mathrm{1}}}} \, \ottnt{e_{{\mathrm{2}}}} $ and $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  \ottsym{[}  \ottmv{x}  \mapsto  \ottnt{E_{{\mathrm{2}}}}  \ottsym{]} \,  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}}  \ottsym{[}  \ottmv{x}  \mapsto  \ottnt{e_{{\mathrm{2}}}}  \ottsym{]} \, $. By induction hypothesis, we have $\varnothing  \vdash  \ottnt{e_{{\mathrm{1}}}}  \ottsym{:}  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{2}}}  \ottsym{.}  \tau_{{\mathrm{1}}}  \ottsym{)}$ where $ \varnothing  \labeledjudge{s}  \ottnt{E_{{\mathrm{1}}}}  :  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{2}}}  \ottsym{.}  T_{{\mathrm{1}}}  \ottsym{)}   \rightsquigarrow   \ottnt{e_{{\mathrm{1}}}} $, $ \varnothing  \labeledjudge{s}  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{2}}}  \ottsym{.}  T_{{\mathrm{1}}}  \ottsym{)}  :  \star   \rightsquigarrow   \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{2}}}  \ottsym{.}  \tau_{{\mathrm{1}}}  \ottsym{)} $. And $\varnothing  \vdash  \ottnt{e_{{\mathrm{2}}}}  \ottsym{:}  \tau_{{\mathrm{2}}}$ where $ \varnothing  \labeledjudge{s}  \ottnt{E_{{\mathrm{2}}}}  :  T_{{\mathrm{2}}}   \rightsquigarrow   \ottnt{e_{{\mathrm{2}}}} $, $ \varnothing  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. Thus by rule \ruleref{T\_App}, we have $\varnothing  \vdash  \ottnt{e_{{\mathrm{1}}}} \, \ottnt{e_{{\mathrm{2}}}}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{[}  \ottmv{x}  \mapsto  \ottnt{e_{{\mathrm{2}}}}  \ottsym{]} \,$.
        \item[Case \ruleref{TR\_Lam}:] Suppose $ \varnothing  \labeledjudge{s}  \ottsym{(}  \lambda  \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \ottsym{.}  \ottnt{E}  \ottsym{)}  :  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \ottsym{.}  T_{{\mathrm{2}}}  \ottsym{)}   \rightsquigarrow   \lambda  \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \ottnt{e} $ and $ \varnothing  \labeledjudge{s}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \ottsym{.}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}} $. By induction hypothesis, we have $\varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \vdash  \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{2}}}$ where $ \varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \labeledjudge{s}  \ottnt{E}  :  T_{{\mathrm{2}}}   \rightsquigarrow   \ottnt{e} $, $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $, $ \varnothing  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. And $\varnothing  \vdash  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}}  \ottsym{:}  \star$ where $ \varnothing  \labeledjudge{s}  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \ottsym{.}  T_{{\mathrm{2}}}  \ottsym{)}  :  \star   \rightsquigarrow   \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}} $. Thus by rule \ruleref{T\_Lam}, we have $\varnothing  \vdash  \ottsym{(}  \lambda  \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \ottnt{e}  \ottsym{)}  \ottsym{:}  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}}  \ottsym{)}$.
        \item[Case \ruleref{TR\_Pi}:] Suppose $ \varnothing  \labeledjudge{s}  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \ottsym{.}  T_{{\mathrm{2}}}  \ottsym{)}  :  \star   \rightsquigarrow   \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}} $. By induction hypothesis, we have $\varnothing  \vdash  \tau_{{\mathrm{1}}}  \ottsym{:}  \star$ where $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $. And $\varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \vdash  \tau_{{\mathrm{2}}}  \ottsym{:}  \star$ where $ \varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  T_{{\mathrm{1}}}  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. Thus by rule \ruleref{T\_Pi} $\varnothing  \vdash  \ottsym{(}  \Pi \, \ottmv{x}  \ottsym{:}  \tau_{{\mathrm{1}}}  \ottsym{.}  \tau_{{\mathrm{2}}}  \ottsym{)}  \ottsym{:}  \star$.
        \item[Case \ruleref{TR\_CastUp}:] Suppose $ \varnothing  \labeledjudge{s}  \ottsym{(}  \kw{cast}^{\uparrow} \, \ottsym{[}  T_{{\mathrm{1}}}  \ottsym{]} \,  \ottnt{E}  \ottsym{)}  :  T_{{\mathrm{1}}}   \rightsquigarrow   \kw{cast}^{\uparrow} \, \ottsym{[}  \tau_{{\mathrm{1}}}  \ottsym{]} \,  \ottnt{e} $ and $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $. By induction hypothesis, we have $\varnothing  \vdash  \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{2}}}$ where $ \varnothing  \labeledjudge{s}  \ottnt{E}  :  T_{{\mathrm{2}}}   \rightsquigarrow   \ottnt{e} $, $ \varnothing  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. We also have $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $ and $T_{{\mathrm{1}}}  \longrightarrow  T_{{\mathrm{2}}}$. By Lemma \ref{lem:appendix:src:redtr}, we obtain $\tau_{{\mathrm{1}}}  \longrightarrow  \tau_{{\mathrm{2}}}$. Thus, by rule \ruleref{T\_CastUp}, we have $\varnothing  \vdash  \kw{cast}^{\uparrow} \, \ottsym{[}  \tau_{{\mathrm{1}}}  \ottsym{]} \,  \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{1}}}$.
        \item[Case \ruleref{TR\_CastDown}:] Suppose $ \varnothing  \labeledjudge{s}  \ottsym{(}  \kw{cast}_{\downarrow} \, \ottnt{E}  \ottsym{)}  :  T_{{\mathrm{2}}}   \rightsquigarrow   \kw{cast}_{\downarrow} \, \ottnt{e} $ and $ \varnothing  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. By induction hypothesis, we have $\varnothing  \vdash  \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{1}}}$ where $ \varnothing  \labeledjudge{s}  \ottnt{E}  :  T_{{\mathrm{1}}}   \rightsquigarrow   \ottnt{e} $, $ \varnothing  \labeledjudge{s}  T_{{\mathrm{1}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $. We also have $T_{{\mathrm{1}}}  \longrightarrow  T_{{\mathrm{2}}}$ and $ \varnothing  \labeledjudge{s}  T_{{\mathrm{2}}}  :  \star   \rightsquigarrow   \tau_{{\mathrm{2}}} $. By Lemma \ref{lem:appendix:src:redtr}, we obtain $\tau_{{\mathrm{1}}}  \longrightarrow  \tau_{{\mathrm{2}}}$. Thus, by rule \ruleref{T\_CastDown}, we have $\varnothing  \vdash  \kw{cast}_{\downarrow} \, \ottnt{e}  \ottsym{:}  \tau_{{\mathrm{2}}}$.
        \item[Case \ruleref{TR\_Mu}:] Suppose $ \varnothing  \labeledjudge{s}  \ottsym{(}  \mu \, \ottmv{x}  \ottsym{:}  T  \ottsym{.}  \ottnt{E}  \ottsym{)}  :  T   \rightsquigarrow   \mu \, \ottmv{x}  \ottsym{:}  \tau  \ottsym{.}  \ottnt{e} $ and $ \varnothing  \labeledjudge{s}  T  :  \star   \rightsquigarrow   \tau $. By induction hypothesis, we have $\varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  \tau  \vdash  \ottnt{e}  \ottsym{:}  \tau$ where $ \varnothing  \ottsym{,}  \ottmv{x}  \ottsym{:}  T  \labeledjudge{s}  \ottnt{E}  :  T   \rightsquigarrow   \ottnt{e} $. Thus by rule \ruleref{T\_Mu}, we have $\varnothing  \vdash  \ottsym{(}  \mu \, \ottmv{x}  \ottsym{:}  \tau  \ottsym{.}  \ottnt{e}  \ottsym{)}  \ottsym{:}  \tau$.
        \item[Case \ruleref{TR\_Case}:] Suppose $ \varnothing  \labeledjudge{s}  \kw{case} \, \ottnt{E_{{\mathrm{1}}}} \, \kw{of} \, \,\overline{  \ottnt{p}  \Rightarrow  \ottnt{E_{{\mathrm{2}}}}  }\,  :  T   \rightsquigarrow   \ottsym{(}  \kw{cast}_{\downarrow}^n \, \ottnt{e_{{\mathrm{1}}}}  \ottsym{)} \, \tau \, \,\overline{  \ottnt{e_{{\mathrm{2}}}}  }\, $ and $ \varnothing  \labeledjudge{s}  T  :  \star   \rightsquigarrow   \tau $. By induction hypothesis, we have $ \varnothing  \labeledjudge{s}  \ottnt{E_{{\mathrm{1}}}}  :  S   \rightsquigarrow   \ottnt{e_{{\mathrm{1}}}} $ and $\,\overline{   \varnothing  \labeledjudge{p}  \ottnt{p}   \Rightarrow   \ottnt{E_{{\mathrm{2}}}}  :  S   \rightarrow   T   \rightsquigarrow   \ottnt{e_{{\mathrm{2}}}}   }\,$. And $\varnothing  \vdash  \ottnt{e_{{\mathrm{1}}}}  \ottsym{:}  \tau_{{\mathrm{1}}}$ where $ \varnothing  \labeledjudge{s}  S  :  \star   \rightsquigarrow   \tau_{{\mathrm{1}}} $. By rule \ruleref{TRpat\_Alt}, we have
        \begin{align*}
        ...
        where
        \begin{align*}
            & \varnothing  \labeledjudge{s}  \ottnt{E_{{\mathrm{2}}}}  :  T   \rightsquigarrow   \ottnt{e}  \\
            &\varnothing  \vdash  \ottnt{e}  \ottsym{:}  \tau \\
            & \varnothing  \labeledjudge{s}  S_{{\mathrm{1}}}  \ottsym{[}  \,\overline{  \ottnt{u}  \mapsto  \upsilon  }\,  \ottsym{]} \,  :  \star   \rightsquigarrow   \sigma 
        \end{align*}
        By rule \ruleref{TRdecl\_Data}, we have $\ottmv{D}  \equiv  \mu \, \ottmv{X}  \ottsym{:}  \ottsym{(}  \,\overline{  \ottnt{u}  \ottsym{:}  \sigma  ^{*}  }\,  \ottsym{)}  \rightarrow  \star  \ottsym{.}  \lambda  \,\overline{  \ottnt{u}  \ottsym{:}  \sigma  ^{*}  }\,  \ottsym{.}  \ottsym{(}  \alpha  \ottsym{:}  \star  \ottsym{)}  \rightarrow  \,\overline{  \ottsym{(}  \,\overline{  \sigma  }\,  \ottsym{[}  \ottmv{D}  \mapsto  \ottmv{X}  \ottsym{]} \,  \rightarrow  \alpha  \ottsym{)}  }\,  \rightarrow  \alpha$. Thus, $\tau_{{\mathrm{1}}}  \equiv  \ottmv{D}  ^{*} \,\overline{  \sigma  ^{*}  }\,$ where $\,\overline{   \varnothing  \labeledjudge{s}  \upsilon  :  \star   \rightsquigarrow   \sigma  ^{*}   }\,$. Then by rule \ruleref{T\_CastDown} and the definition of $n$-step cast operator, the type of $\kw{cast}_{\downarrow}^n \, \ottnt{e_{{\mathrm{1}}}}$ is $\ottsym{(}  \alpha  \ottsym{:}  \star  \ottsym{)}  \rightarrow  \,\overline{  \ottsym{(}  \,\overline{  \sigma  }\,  \rightarrow  \alpha  \ottsym{)}  }\,  \rightarrow  \alpha$. Note that by rule \ruleref{T\_Lam}, $\varnothing  \vdash  \ottnt{e_{{\mathrm{2}}}}  \ottsym{:}  \,\overline{  \sigma  }\,  \rightarrow  \tau$. Therefore, by rule \ruleref{T\_App}, we obtain $\varnothing  \vdash  \ottsym{(}  \kw{cast}_{\downarrow}^n \, \ottnt{e_{{\mathrm{1}}}}  \ottsym{)} \, \tau \, \,\overline{  \ottnt{e_{{\mathrm{2}}}}  }\,  \ottsym{:}  \tau$, which follows the result.
    \end{description}
\end{proof}
