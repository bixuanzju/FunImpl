...
As discussed in \S\ref{sec:rec} \bruno{where? words like before and
  after are a bad smell. In academic writing we use references. Just
  add the reference to the section.} \jeremy{fixed}, bringing general
...
to be discussed here. Also the calculus of inductive constructions should deserve some mention.} \jeremy{added CIC and Conor McBride's work}
