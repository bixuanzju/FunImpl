...
work of Henk and others.} \jeremy{done!}
...
\bruno{work by Conor Mcbride on encoding datatypes? That needs 
to be discussed here. Also the calculus of inductive constructions should deserve some mention.} \jeremy{added CIC, which work of Conor Mcbride? Towards Observational Type Theory is the paper i searched}
